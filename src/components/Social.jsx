...
function Social({ icon, bgColor }) {
	const hoverClass = `hover:bg-[${bgColor}] hover:border-[${bgColor}]`;

	return (
		<div
			className={`w-[46px] h-[46px] border-[2px] border-[#E2E3E4] rounded-full flex items-center justify-center ${hoverClass} `}>
			{icon}
		</div>
	);
}
